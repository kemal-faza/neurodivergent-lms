...
![Slide Tujuan Proyek](./tujuan_proyek_slide_1786634567361.jpg)
...
|                                         TUJUAN PROYEK                                                   |
|                              Empat Tujuan & Manfaat Utama LevelUp                                       |
+----------------------------------------------------+----------------------------------------------------+
| 1. Antarmuka Customizable                          | 2. Kuis Adaptif                                    |
|    • Panel aksesibilitas multi-sensori             |    • Dynamic difficulty scaling otomatis           |
|    • Mitigasi cognitive overload disleksia         |    • Menjaga flow state belajar learner            |
|                                                    |                                                    |
| 3. Gamifikasi & Atensi                             | 4. Inklusi Web CITECH                              |
|    • Reward loop (poin, streak, badge)             |    • Bukti nyata web frontend inklusif             |
|    • Mempertahankan fokus learner ADHD             |    • Solusi nyata Subtema Education                |
+----------------------------------------------------+----------------------------------------------------+
| Tim: Menunggu Kabar | Universitas Diponegoro                                                            |
+---------------------------------------------------------------------------------------------------------+
```
...
### **Judul & Subjudul:**
* **Judul:** Tujuan Proyek
* **Subjudul:** Empat Tujuan & Manfaat Utama LevelUp
...
> **Prinsip Penyampaian:** Presenter menghubungkan setiap tujuan teknis dengan masalah nyata (*problem-solving context*) yang dihadapi anak-anak neurodivergen.
...
## 4. Parameter & Landasan Pendukung (Rujukan Tanya Jawab / Q&A)

* **Cognitive Load Theory (Sweller):** Antarmuka disesuaikan untuk meminimalkan *extraneous cognitive load* melalui tipografi khusus dan pemandu baris fokus.
* **Flow Theory (Csikszentmihalyi):** Kuis adaptif dirancang agar tantangan (*challenge*) selalu seimbang dengan kemampuan (*skill*) *learner*, mencegah kebosanan (*boredom*) dan kecemasan (*anxiety*).
* **Dopamine Loop pada ADHD:** Gamifikasi visual non-distraktif memberikan penguatan positif berkala (*intermittent positive reinforcement*) untuk mempertahankan atensi belajar.
* **Relevansi CITECH 2026:** Mendukung tujuan *Education for All* (SDG 4) melalui platform berkelanjutan (*zero server cost*, *offline capability*).
