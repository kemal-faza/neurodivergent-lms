...
export const KUIS: Kuis[] = [
  {
    ...
    soal: [
      ...
      { id: "q1s9", t: "Apa peran stomata pada daun?", opsi: ["Tempat masuk keluarnya gas", "Menyimpan air", "Menyerap garam"], benar: 0, diff: 2 },
      { id: "q1s10", t: "Bagian daun mana yang banyak mengandung klorofil?", opsi: ["Epidermis", "Mesofil (jaringan tengah daun)", "Tulang daun"], benar: 1, diff: 2 },
      ...
      { id: "q1s12", t: "Persamaan kimia fotosintesis yang paling tepat adalah?", opsi: ["6CO2 + 6H2O → C6H12O6 + 6O2 (dengan bantuan cahaya)", "6O2 + 6H2O → C6H12O6 + 6CO2", "C6H12O6 + 6O2 → 6CO2 + 6H2O"], benar: 0, diff: 3 },
      ...
      { id: "q1s14", t: "Faktor yang TIDAK memengaruhi laju fotosintesis adalah?", opsi: ["Intensitas cahaya", "Kadar karbon dioksida", "Warna pot bunga"], benar: 2, diff: 3 },
      { id: "q1s15", t: "Apa yang terjadi jika tumbuhan kekurangan air saat siang terik?", opsi: ["Fotosintesis meningkat", "Stomata menutup sehingga fotosintesis menurun", "Tumbuhan menghasilkan oksigen lebih banyak"], benar: 1, diff: 3 },
    ],
  },
  {
    id: "q2",
    ...
    soal: [
      ...
      { id: "q2s6", t: "Benda langit yang memancarkan cahaya sendiri adalah?", opsi: ["Planet", "Bintang", "Bulan"], benar: 1, diff: 1 },
      { id: "q2s7", t: "Planet apakah yang dijuluki Planet Merah?", opsi: ["Venus", "Mars", "Merkurius"], benar: 1, diff: 2 },
      { id: "q2s8", t: "Apa nama satelit alami Bumi?", opsi: ["Bulan", "Matahari", "Mars"], benar: 0, diff: 2 },
      { id: "q2s9", t: "Planet manakah yang letaknya paling jauh dari Matahari?", opsi: ["Uranus", "Saturnus", "Neptunus"], benar: 2, diff: 2 },
      { id: "q2s10", t: "Mengapa planet tidak terlihat berkedip seperti bintang?", opsi: ["Planet lebih dekat sehingga cahayanya lebih stabil", "Planet memancarkan cahaya sendiri", "Planet bergerak sangat cepat"], benar: 0, diff: 2 },
      { id: "q2s11", t: "Apa penyebab utama terjadinya siang dan malam di Bumi?", opsi: ["Bumi mengelilingi Matahari", "Bumi berputar pada porosnya", "Matahari bergerak mengelilingi Bumi"], benar: 1, diff: 3 },
      ...
      { id: "q2s13", t: "Apa perbedaan utama antara planet dalam dan planet luar?", opsi: ["Letaknya terhadap sabuk asteroid", "Warna permukaannya", "Jumlah bulannya"], benar: 0, diff: 3 },
      { id: "q2s14", t: "Mengapa suhu di Venus lebih panas daripada Merkurius?", opsi: ["Venus lebih dekat ke Matahari", "Efek rumah kaca oleh atmosfer Venus yang tebal", "Venus tidak memiliki atmosfer"], benar: 1, diff: 3 },
      { id: "q2s15", t: "Bagaimana kecepatan orbit planet yang lebih jauh dari Matahari?", opsi: ["Semakin lambat", "Semakin cepat", "Tetap sama"], benar: 0, diff: 3 },
    ],
  },
];
